...
Task 0 Description:   
For this task, assume that there is no wind resistance. Assuming 
...
Im = 4;		    % Fixed motor current in A for Task 0
tf = 30;		% Final time in seconds for Task 0
tdelta = 15;	% Time step in seconds
